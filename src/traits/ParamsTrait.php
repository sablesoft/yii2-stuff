...
trait ParamsTrait
{
    ...
    public static function get(?string $path = null, $default = null)
    {
        ...
        return ArrayHelper::getValue(static::$params, $path, $default);
    }
    ...
    {
        static::prepare();
        $array = $path ? (array) static::get($path, []) : static::$params;
    ...
    protected static function prepare() : void
    {
        ...
        if ($path == null) {
            static::$params = \Yii::$app->params;
            return;
        }

        static::$params = !empty(\Yii::$app->params[$path]) ?
            \Yii::$app->params[$path] : [];
