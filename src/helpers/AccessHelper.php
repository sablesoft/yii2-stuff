...
namespace sablesoft\stuff\helper;
...
class AccessHelper implements ParamsInterface
{
    ...
    {
        if (static::have($sender->module->getUniqueId(), static::PARAMS_SKIP_MODULE)) return true;
    ...
    public static function getPermission(Controller $sender) : string
    {
        ...
        return preg_replace(
            ...
            [$sender->module->id, $sender->getUniqueId(), $sender->action->getUniqueId()],
    ...
    protected static function getPattern(Controller $sender) : string
    {
        ...
        $moduleKey = $sender->module->getUniqueId();
